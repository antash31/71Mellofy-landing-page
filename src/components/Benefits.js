  ...
  return (
    <section className="relative py-24 px-6 bg-black overflow-hidden">
      ...
      <div className="max-w-7xl mx-auto relative z-10">
          ...
          {stats.map((stat, index) => (
            ...
            >
              ...
              <div className="relative">
                <div className="text-5xl md:text-6xl font-poppins font-semibold tracking-tight text-white mb-4">
                  {stat.value}
                </div>
        ...
        >
          <h3 className="text-3xl font-poppins font-semibold tracking-tight text-white mb-10 text-center">
            Additional Benefits
          </h3>
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
            {benefits.map((benefit, index) => (
              ...
              >
                ...
                <span className="font-inter text-sm tracking-normal text-white/80">{benefit}</span>
              </motion.div>
            ))}
          </div>
        </motion.div>
