    ...
    >
      <form onSubmit={handleSubmit} className="space-y-5">
        ...
        <div className="text-xs text-white/60 font-montserrat tracking-wide">
          ...
          <a href="/terms" className="text-white/80 hover:text-white underline transition-colors duration-200">
            Terms of Service
          </a>{" "}
          and{" "}
          <a href="/privacy" className="text-white/80 hover:text-white underline transition-colors duration-200">
            Privacy Policy
          </a>
        </div>
